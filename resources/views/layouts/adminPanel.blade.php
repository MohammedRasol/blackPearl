...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('adminPanel/images/favicon/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('adminPanel/images/favicon/favicon-16x16.png') }}">
