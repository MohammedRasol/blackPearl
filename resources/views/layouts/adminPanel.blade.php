                                ...
                                <div data-pixr-simplebar>
                                    <ul class="list-unstyled m-0 pb-4">
                                        <li class="d-flex py-2 align-items-start">
                                            <button
                                                class="btn-icon bg-primary-faded text-primary fw-bolder me-3">O</button>
                                        ...
                                        <li class="d-flex py-2 align-items-start">
                                            <button
                                                class="btn-icon bg-primary-faded text-primary fw-bolder me-3">M</button>
                                            <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                                <div>
                                        ...
                                        <li class="d-flex py-2 align-items-start">
                                            <button
                                                class="btn-icon bg-primary-faded text-primary fw-bolder me-3">D</button>
                                            <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                                <div>
                                        ...
                                        <li class="d-flex py-2 align-items-start">
                                            <button
                                                class="btn-icon bg-primary-faded text-primary fw-bolder me-3">E</button>
                                            <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                                <div>
                        ...
                        <button class="btn btn-link p-0 position-relative" type="button" id="profileDropdown"
                            ...
                            <picture>
                                <img class="f-w-10 rounded-circle"
                                    src="{{ asset('adminPanel/images/profile-small.jpeg') }}"
                    ...
                    <ul class="list-unstyled mb-6">
                        ...
                        <li class="menu-item"><a class="d-flex align-items-center" href="./charts.html">
                                ...
                                <span class="menu-link">
                                    Charts
                                    <span
                                        class="badge bg-danger-faded text-danger pb-1 ms-2 align-middle rounded-pill">new</span>
                                </span></a></li>
                        <!-- / Dashboard Menu Section-->
                        ...
                        <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                                data-bs-toggle="collapse" data-bs-target="#collapseMenuItemPages"
                            ...
                            <div class="collapse  {{ Route::currentRouteName() == 'allUsers' || Route::currentRouteName() == 'editUsers' || Route::currentRouteName() == 'addUsers' ? 'show' : '' }}"
                                ...
                                <ul class="submenu">
                                    <li><a href="{{ route('allUsers') }}"
                                            class="{{ Route::currentRouteName() == 'allUsers' ? 'active' : '' }}">All
                                            Users</a></li>
                                    <li><a href="{{ route('addUser') }}"
                                            class="{{ Route::currentRouteName() == 'addUser' ? 'active' : '' }}">Add
                                            User</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="menu-section mt-4">Countries Management</li>
                        <li class="menu-item"><a
                                class="d-flex align-items-center  {{ Route::currentRouteName() == 'allCountries' || Route::currentRouteName() == 'editCountry' || Route::currentRouteName() == 'addCountry' ? '' : 'collapsed' }} "
                                href="#" data-bs-toggle="collapse" data-bs-target="#collapseMenuItemCountries"
                                aria-expanded="false" aria-controls="collapseMenuItemCountries">
                                <span class="menu-icon">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
                                ...
                                <span class="menu-link">Countries</span></a>
                            <div class="collapse   {{ Route::currentRouteName() == 'allCountries' || Route::currentRouteName() == 'editCountry' || Route::currentRouteName() == 'addCountry' ? '' : 'collapsed' }}"
                                id="collapseMenuItemCountries">
                                <ul class="submenu">
                                    <li><a href="{{ route('allCountries') }}"
                                            class="{{ Route::currentRouteName() == 'allCountries' ? 'active' : '' }}">All
                                            Countries</a></li>
                                    <li><a href="{{ route('addCountry') }}"
                                            class="{{ Route::currentRouteName() == 'addCountry' ? 'active' : '' }}">Add
                                            Country</a></li>
                                </ul>
                            </div>
                        </li>
