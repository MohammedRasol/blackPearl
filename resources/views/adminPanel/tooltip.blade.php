...
@section('content')
    ...
    <main id="main">
        ...
        <section class="container-fluid">
            ...
            <!-- Page Title-->
            <h2 class="fs-4 mb-2">Tooltips</h2>
            <p class="text-muted mb-4">Documentation and examples for adding custom Bootstrap tooltips with CSS and
                JavaScript using CSS3 for animations and data-bs-attributes for local title storage.</p>
            <!-- / Page Title-->
            ...
            <div class="row g-4">
                <div class="col-12 col-md-6">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="tooltip"
