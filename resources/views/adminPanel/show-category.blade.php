     ...
     <main id="main">
         ...
         <section class="container-fluid">
             ...
             <form action="" method="POST">
                 <input type="hidden" id="image-type" value="category">
                                 ...
                                 <div class="row p-5">
                                     <div class="col-6">
                                         ...
                                         <input type="text" class="form-control" id="category-name" name="name_ar"
                                             dir="rtl" value="{{ $category->name_ar }}"
                                             placeholder="Category Name ARABIC">
                                     </div>
                                     <div class="col-6">
                                         <label for="category-name" class="form-label">Category Name ENGLISH</label>
                                         <input type="text" class="form-control" id="category-name" name="name_en"
                                             value="{{ $category->name_en }}" placeholder="Category Name ENGLISH">
                                     </div>
