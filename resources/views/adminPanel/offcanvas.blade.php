    ...
    <div
      ...
      <div class="d-flex justify-content-end align-items-center mt-3 mt-md-0">
        ...
        <a class="btn btn-sm btn-primary-faded ms-2" href="#"><i class="ri-settings-3-line align-bottom"></i>
          Settings</a>
        <a class="btn btn-sm btn-secondary-faded ms-2 text-body" href="#"><i class="ri-question-line align-bottom"></i>
          Help</a>
      </div>
    </div>
  </div> <!-- / Breadcrumbs-->
      ...
      <div class="offcanvas-header position-relative">
        <div class="d-flex flex-column w-100">
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="dropdown">
              <button class="btn btn-link dropdown-toggle dropdown-toggle-icon p-0" type="button" id="dropdownTop"
          ...
          <div class="overflow-hidden">
            ...
            <div class="d-flex align-items-end justify-content-start mb-4 flex-wrap">
              ...
              <div class="d-flex justify-content-start flex-column align-items-start col">
                <small class="text-muted fs-xs fw-bolder"><span class="fw-bold">Patrick Johnson</span> &middot; 2 mins
                  ago</small>
            ...
            <div class="d-flex align-items-end justify-content-start mb-4 flex-wrap">
              ...
              <div class="d-flex justify-content-start flex-column align-items-start col">
                <small class="text-muted fs-xs fw-bolder"><span class="fw-bold">Patrick Johnson</span> &middot; 25 mins
                  ago</small>
                <div class="bg-light p-3 mt-2 rounded-t-s-4 rounded-t-e-4 rounded-b-e-4">
